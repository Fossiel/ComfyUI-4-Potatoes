...
#----------START OF CENTRAL COMFYUI POINTERS--------------
...
#################################################################
# Change the "ComfyUI" in the following uncommented line to the folder name of your main ComfyUI install only if it isn't "ComfyUI" already. Do not forget the double quotes.
#################################################################
original_base_path = os.path.abspath(os.path.join(base_path, "..", "ComfyUI"))
models_dir = os.path.join(original_base_path, "models")  # Local models directory for safety
...
# Point to original ComfyUI directories
folder_names_and_paths["custom_nodes"] = ([os.path.join(original_base_path, "custom_nodes")], set())
output_directory = os.path.join(original_base_path, "output")
temp_directory = os.path.join(original_base_path, "temp")
input_directory = os.path.join(original_base_path, "input")
user_directory = os.path.join(base_path, "user")

#----------END OF CENTRAL COMFYUI POINTERS--------------
